...
namespace Restaurant.Areas.Admin.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            // Last 7 days data
            var last7DaysSales = _context.order_detail
            ...
            var previous7DaysSales = _context.order_detail
            ...
            var reportData = Enumerable.Range(0, 7)
              ...
              {
                  Date = date,
                  Order = _context.order_detail.Count(od => od.order.createdDate.HasValue && od.order.createdDate.Value.Date == date),
                  Revenue = _context.order_detail
            ...
            var topSellingProducts = _context.order_detail
